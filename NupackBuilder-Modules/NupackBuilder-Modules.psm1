...
)
{
	...
	$excluded = @("MSCaptcha.dll", "AjaxMin.dll", "ChilkatDotNet2.x32", "ChilkatDotNet2.x32", "ChilkatDotNet2.dll", "Heijden.Dns.dll", "Microsoft.Xrm.Sdk.dll", "Microsoft.Xrm.Client.dll", "Microsoft.Xrm.Sdk.Deployment.dll", "Microsoft.Xrm.Sdk.dll", "Sitecore.ExperienceEditor.dll")
